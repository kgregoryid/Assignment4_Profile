...
// in simulator we redefine to format for Profile Developer console
...
{\
	NSString * exceptionName = [@"org.profile." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.profile";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProfileNativeItemNone = -1, 
	UIProfileNativeItemSpinner = -2,
	UIProfileNativeItemProgressBar = -3,
	
	UIProfileNativeItemSlider = -4,
	UIProfileNativeItemSwitch = -5,
	UIProfileNativeItemMultiButton = -6,
	UIProfileNativeItemSegmented = -7,
	
	UIProfileNativeItemTextView = -8,
	UIProfileNativeItemTextField = -9,
	UIProfileNativeItemSearchBar = -10,
	
	UIProfileNativeItemPicker = -11,
	UIProfileNativeItemDatePicker = -12,
	
	UIProfileNativeItemInfoLight = -13,
	UIProfileNativeItemInfoDark = -14,
	
	UIProfileNativeItemDisclosure = -15,
	
	UIProfileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Profile instances of
